torchrun --standalone --nnodes=1 --nproc-per-node=8  train.py --bsz 8 -s datasets/MatrixCity/aerial/small_city/aerial/train/block_all --resolution 1 --model_path output/MatrixCity --iterations 150000  \
...
python render.py --bsz 1 -s datasets/MatrixCity/aerial/small_city/aerial/test/block_all_test --resolution 1 \
    --model_path output/MatrixCity --images images --skip_train --eval